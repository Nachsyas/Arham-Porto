...
export default function HeroPortrait({
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[3/4] rounded-2xl border border-border bg-surface p-2.5 sm:p-3 shadow-md overflow-hidden hover:border-primary/40 transition-colors duration-500">
        ...
        <div className="relative w-full h-full rounded-xl overflow-hidden bg-surface-strong border border-border/50">
          {!hasError ? (
            <>
              <Image
          ...
          <div className="absolute bottom-0 inset-x-0 p-3 bg-surface/90 border-t border-border/60 backdrop-blur-sm flex items-center justify-between z-10">
            <span className="text-[11px] font-code text-themeText-primary font-semibold tracking-wide">
              NACHSYAS ARHAM
            </span>
            <span className="text-[10px] font-code text-primary font-semibold tracking-wider uppercase">
              {role}
            </span>
          </div>
        </div>
